...
Look, inspired by slurm.io: dark navy header with an electric-cyan accent,
white cards on a light ground, pill badges, generous spacing. Self-contained
...
def page(title: str, subtitle: str, body: str, generator: str,
    ...
    return (
        ...
        f"<footer>Generated by <code>{generator}</code> &middot; Slurm stand</footer>"
        "</div></body></html>")
